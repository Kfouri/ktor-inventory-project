...
import com.kfouri.data.requests.SingInRequest
...
fun Route.singUp(
    ...
    post("singup") {
        val request = runCatching { call.receiveNullable<SingUpRequest>() }.getOrNull() ?: run {
...
fun Route.singIn(
    ...
    post("singin") {
        val request = runCatching { call.receiveNullable<SingInRequest>() }.getOrNull() ?: run {
            call.respond(HttpStatusCode.BadRequest)
            return@post
        }
